...
<div class="product_meta">
	...
	<?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
		...
		<span class="sku_wrapper"><?php _e( 'Part Number:', 'woocommerce' ); ?> <span class="sku" style="color:#000;" itemprop="sku"><?php echo ( $sku = $product->get_sku() ) ? $sku : __( 'N/A', 'woocommerce' ); ?></span></span><br />
