...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
 ...
 <!--BENZ--><th class="td" scope="col" style="text-align:left;"><?php _e( 'Total', 'woocommerce' ); ?></th>
		</tr>
	</thead>
	<tbody>
		...
		<?php
			if ( $totals = $order->get_order_item_totals() ) {
				...
				foreach ( $totals as $total ) {
					$i++;
					?><tr>
			 <!--BENZ--><th class="td" scope="col" colspan="3" style="font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: 4px;'; ?>"><?php echo $total['label']; ?></th>
