          ...
          <div class="row">
            <div id="content" role="main">
                <div class="col-md-4" style="">
                  <a href="<?php echo site_url(); ?>/product-category/simulated-iv-bags/"><img style="width:100%;" src="wp-content/imgs/homepage/Simulated-iv-fluids.png" /></a>
                </div>
                <div class="col-md-4" style="">
                  <a href="http://www.diamedicalusa.com/Catalog.pdf" target="_blank"><img style="width:100%;" src="wp-content/imgs/homepage/download-catalog.png" /></a>
                </div>
                <div class="col-md-4" style="">
                <a href="<?php echo site_url(); ?>/product-category/carts-storage/loaded-crash-carts/">  <img style="width:100%;" src="wp-content/imgs/homepage/loaded-crash-carts.png" /></a>
                </div>
            </div><!-- /#content -->
          </div><!-- /.row -->
