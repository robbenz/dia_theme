 ...
 <div class="row">
  <div class="col-md-3">
    <ul>
      ...
      <a href="<?php echo site_url(); ?>/product-category/hospital-beds/span-america-beds/">
        <li>Span America Low Beds</li>
      </a>
      <a href="<?php echo site_url(); ?>/product-category/hospital-beds/stryker-beds/">
        <li>Stryker Beds</li>
      </a>
      <a href="<?php echo site_url(); ?>/product-category/hospital-beds/">
  ...
  <div class="col-md-3">
    <ul>
      ...
      <a href="<?php echo site_url(); ?>/product-category/refrigerators-freezers/counter-height-refrigerators/">
        <li>Counter Height Refrigerators</li>
      </a>
      <a href="<?php echo site_url(); ?>/product-category/refrigerators-freezers/vaccine-freezers-2/">
        <li>Vaccine Freezers</li>
      </a>
      <a href="<?php echo site_url(); ?>/product-category/refrigerators-freezers/vaccine-refrigerators-2/">
        <li>Vaccine Refrigerators</li>
      </a>
      <a href="<?php echo site_url(); ?>/product-category/refrigerators-freezers/">
        <li class="menu-view-all">View All</li>
      </a>
