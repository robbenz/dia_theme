<div class="col-md-9 mve_cols" id="ems_main">
  <div class="row">
    <div class="col-md-12">
      <h3 style="background-color:#d6001c;">Emergency &amp; Rescue Equipment</h3>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6">
      <a href="<?php echo site_url(); ?>/emergency-rescue/">
        <h4>Education &amp; Training Equipment</h4>
      </a>
    </div>
    <div class="col-md-6">
      <a href="<?php echo site_url(); ?>/field-ready-ems-equipment/">
        <h4>Field Ready Gear</h4>
      </a>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <img style="width:100%;" src="<?php echo site_url(); ?>/wp-content/imgs/loaded-emergency-packs-banner.png" />
    </div>
    <div class="col-md-3">
      <ul>
