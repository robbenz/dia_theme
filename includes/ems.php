...
?>
 ...
 <img src="<?php echo site_url(); ?>/wp-content/imgs/ems/ems-catalog-button.png" alt="Emergency &amp; Rescue Training" /></a>
            ...
            <p class="diva" style=" float: right; font-size: 12.45px; text-align: center; width: 98%;">
              ...
              and stair chairs.
              <br /> Choose from our simulated IV bags, simulated normal saline, simulated lactated ringers, and simulated blood bags. Out simulated IV bags come in a variety of sizes and are available for purchase pre-filled, empty, in bulk or individually.
