<?php
/* Template Name: Service HomePage*/
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-8">
        <div id="content" role="main">
          ...
          <div id="pm_ltgreen_2"><p>or</p></div>
          ...
          <div class="new_pm_row row">
            <div class="col-sm-3 col-xs-3">
              <a href="<?php echo site_url(); ?>/site-repairs-preventive-maintenance/exam-tables-repairs/">
                ...
                <div class="pm_square">EXAM TABLE <span class="pm_white">SERVICE</span></div>
              </a>
            </div>
            ...
            <div class="col-sm-3 col-xs-3">
              <a href="<?php echo site_url(); ?>/site-repairs-preventive-maintenance/headwalls-repairs/">
                ...
                <div class="pm_square">HEADWALL <span class="pm_white">INSTALLATION</span></div>
              </a>
            </div>
        ...
        REPAIR
          ...
          <!-- light green #b7dd79 lighter green #e4f2cc -->
          ...
          <p>DiaMedical USA maintains a large network of full-time outside biomedical technicians. These individuals are certified technicians that receive extensive training and continuing education for the product lines they support. Our service network
            allows us to provide ongoing equipment management in the field.</p>

          <p>Each piece of equipment is backed by a one year warranty. Our on-site maintenance team provides your facility with 24-hour availability, access to discounted parts and expedited parts replacement. The result is well-maintained, quality equipment
            with minimal downtime all while saving money.</p>
