...
<ul class="products">
  ...
  <li class="product-category product">
    <a href="<?php echo site_url(); ?>/product-category/infusion-dialysis/">
      <img src="<?php echo site_url(); ?>/wp-content/uploads/2015/02/Alaris-Imed-Gemini-PC-4-Infusion-PumpPC-4_400x400-258x275.png" alt="Infusion &amp; Dialysis" width="250" height="275" />
      <h3>
        Infusion &amp; Dialysis
      </h3>
    </a>
  ...
  <li class="product-category product">
    <a href="<?php echo site_url(); ?>/product-category/respiratory/">
      <img src="<?php echo site_url(); ?>/wp-content/uploads/2015/02/Puritan-Bennett-760-Ventilator_400x400-258x275.png" alt="Respiratory" width="250" height="275" />
      <h3>
        Respiratory
      </h3>
    </a>
  ...
  <li class="product-category product">
    <a href="<?php echo site_url(); ?>/product-category/mobility/walkers/">
      <img src="<?php echo site_url(); ?>/wp-content/uploads/2015/07/PF05009_PRI01-258x275.jpg" alt="Walkers" width="250" height="275" />
      <h3>
        Walkers
      </h3>
    </a>
