...
if (function_exists('benz_add_category_headers')) benz_add_category_headers();

$imagingLinks = array(
  array(
    "name" => "Fujitsu Imaging Parts",
    "img"  => "wpallimport/files/imaging-parts/Fujitsu.png",
    "slug" => "../fujitsu-imaging-parts"
  ),
  array(
    "name" => "GE Imaging Parts",
    "img"  => "wpallimport/files/imaging-parts/GE.png",
    "slug" => "../ge-imaging-parts"
  ),
  array(
    "name" => "Siemens Imaging Parts",
    "img"  => "wpallimport/files/imaging-parts/Siemens.png",
    "slug" => "../siemens-imaging-parts"
  ),
  array(
    "name" => "All Imaging Parts A-L",
    "img"  => "wpallimport/files/imaging-parts/HP.png",
    "slug" => "../imaging-parts-a-l"
  ),
  array(
    "name" => "All Imaging Parts K-Z",
    "img"  => "wpallimport/files/imaging-parts/Toshiba.png",
    "slug" => "../imaging-parts-k-z"
  )

);

if (function_exists('benz_loop_special_cats')) benz_loop_special_cats($imagingLinks);
